...
class PageBlogListingController extends Controller
{
    ...
    public function updatedDataFetch(Request $request): JsonResponse
    {
        try {
            ...
            $data = PageBlogListing::first();

            if (!$data) {
                return sendErrorResponse('Data not found.', '', 404);
            }
            return sendSuccessResponse('Blog Listing page details fetched successfully.', $data);
        } catch (\Throwable $th) {
    ...
    public function update(Request $request): JsonResponse
    {
        try {
            ...
            $checkData = PageBlogListing::first();
            ...
            return sendSuccessResponse('Blog listing page details updated successfully.', '');
        } catch (\Throwable $th) {
            return sendErrorResponse('Something went wrong.', $th->getMessage(), 500);
        }
    }
