...
class SectionForCorporateController extends Controller
{
    ...
    public function updatedDataFetch(Request $request): JsonResponse
    {
        try {
            ...
            $data = SectionForCorporate::first();

            if (!$data) {
                return sendErrorResponse('Data not found.', '', 404);
            }
            return sendSuccessResponse('Section for Corporate details fetched successfully.', $data);
        } catch (\Throwable $th) {
    ...
    public function update(Request $request): JsonResponse
    {
        try {
            ...
            $checkData = SectionForCorporate::first();
